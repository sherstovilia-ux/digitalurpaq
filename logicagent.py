...
cabinet_map_kk = {
    ...
    "шахматы": "Шахмат кабинеті — оң жақ қанат, 1 қабат, LEGO кабинетімен қатар.",
    "биология": "Биология кабинеті — 3 қабат, орталық бөлік, D1 блогы.",
    "электрика": "Электротехника кабинеті — 2 қабат, оң жақ қанат.",
    "дроны": "Дрондар кабинеті — 2 қабат, оң жақ қанат.",
    "3д моделирования": "3D-моделдеу кабинеті — 2 қабат, IT блок, оң жақ қанат.",
    "роботы": "Робототехника кабинеті — 2 қабат, сол жақ қанат, дәліз соңында.",
    "вр": "VR кабинеті — 2 қабат, оң жақ қанат.",
    "програмирование": "Бағдарламалау кабинеті — 2 қабат, алыс оң жақ қанат.",
    "анимирование": "Анимация кабинеті — 2 қабат, оң жақ қанат.",
    "экономика": "Экономика кабинеті — 2 қабат, оң жақ қанат.",
    "рисование": "Сурет кабинеті — 3 қабат, оң жақ қанат.",
}

# ---- TTS Function ----
def tts_audio_bytes(text, lang_code="ru"):
    tts = gTTS(text=text, lang="kk" if lang_code=="kk" else "ru")
    fp = io.BytesIO()
    tts.write_to_fp(fp)
    fp.seek(0)
    return fp.read()
...
# ---- Chat UI с автопроигрыванием TTS ----
    ...
    for i, msg in enumerate(st.session_state.messages):
        ...
        if msg["role"] == "bot":
            ...
            if st.session_state.tts_enabled:
                audio_bytes = tts_audio_bytes(msg["text"], "kk" if st.session_state.lang=="kk" else "ru")
